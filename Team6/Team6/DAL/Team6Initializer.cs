...
namespace Team6.DAL
{
    public class Team6Initializer : System.Data.Entity.DropCreateDatabaseAlways<Team6Context>
    {
        protected override void Seed(Team6Context context)
        {
            ...
            {
                new Officer{OfficerID=654321,BadgeNumber=001,FirstName="John",Rank=Rank.AssistantChief,LastName="Doe",UserName="jdoe",Password="jd001",PhoneNumber=2345067892,Email="john@doe.com",Ssn=123456789,EyeColor=EyeColor.Amber,Height=60,Gender=Gender.Male},
                new Officer{OfficerID=258741,BadgeNumber=002,FirstName="Alex",Rank=Rank.Sergeant,LastName="Murphy",UserName="amurphy",Password="am002",PhoneNumber=2343045823, Email="alex@murphy.com", Ssn=567839201, EyeColor=EyeColor.Blue,Height=70, Gender=Gender.Male},
                new Officer{OfficerID=845162,BadgeNumber=003,FirstName="Matt",Rank=Rank.ChiefOfPolice,LastName="Dillon",UserName="mdillon",Password="md003",PhoneNumber=2304789645, Email="matt@dillon.com", Ssn=789641453, EyeColor=EyeColor.Brown, Height=55, Gender=Gender.Male},
                new Officer{OfficerID=956251,BadgeNumber=004,FirstName="Harry",Rank=Rank.Inspector,LastName="Callahan",UserName="hcallahan",Password="hc004",PhoneNumber=8067539091, Email="harry@callahan.com", Ssn=654210412, EyeColor=EyeColor.Gray, Height=81, Gender=Gender.Male},
                new Officer{OfficerID=764312,BadgeNumber=005,FirstName="Axel",Rank=Rank.Colonel,LastName="Foley",UserName="afoley",Password="af005",PhoneNumber=4568902309, Email="axel@foleycom", Ssn=784241563, EyeColor=EyeColor.Green, Height=89, Gender=Gender.Male},
                new Officer{OfficerID=458963,BadgeNumber=006,FirstName="Martin",Rank=Rank.Detective,LastName="Rigg",UserName="mrigg",Password="mr006",PhoneNumber=7451208056,Email="martin@rigg.com",Ssn=463217896,EyeColor=EyeColor.Green,Height=56,Gender=Gender.Male},
                new Officer{OfficerID=368525,BadgeNumber=007,FirstName="Laverne",Rank=Rank.Sergeant,LastName="Hooks",UserName="lhooks",Password="lh007",PhoneNumber=7451200856,Email="martin@rigg.com",Ssn=528145648,EyeColor=EyeColor.Brown,Height=52,Gender=Gender.Female},
                new Officer{OfficerID=296348,BadgeNumber=008,FirstName="Anne",Rank=Rank.Officer,LastName="Lewis",UserName="alewis",Password="al008",PhoneNumber=3132504809,Email="anne@lewis.com",Ssn=789323141,EyeColor=EyeColor.Blue,Height=50,Gender=Gender.Female},
                new Officer{OfficerID=582148,BadgeNumber=009,FirstName="Amelia",Rank=Rank.Officer,LastName="Donaghy",UserName="adonaghy",Password="ad009",PhoneNumber=2503698412,Email="amelia@donaghy.com",Ssn=598546354,EyeColor=EyeColor.Green,Height=51,Gender=Gender.Female},
                new Officer{OfficerID=896335,BadgeNumber=010,FirstName="David",Rank=Rank.Detective,LastName="Starsky",UserName="dstarsky",Password="ds010",PhoneNumber=2103654859,Email="david@starsky.com",Ssn=112530525,EyeColor=EyeColor.Brown,Height=70,Gender=Gender.Male},
                new Officer{OfficerID=968582,BadgeNumber=011,FirstName="Kenneth",Rank=Rank.Detective,LastName="Hutchinson",UserName="khutchinson",Password="kh011",PhoneNumber=2013654859,Email="kenneth@hutchinson.com",Ssn=201455960,EyeColor=EyeColor.Blue,Height=78,Gender=Gender.Male},
                new Officer{OfficerID=147859,BadgeNumber=012,FirstName="Clarice",Rank=Rank.Officer,LastName="Starling",UserName="cstarling",Password="cs012",PhoneNumber=9688078525,Email="clarice@startling.com",Ssn=784528569,EyeColor=EyeColor.Green,Height=59,Gender=Gender.Female},
                new Officer{OfficerID=828582,BadgeNumber=013,FirstName="Frank",Rank=Rank.Detective,LastName="Drebin",UserName="fdrebin",Password="fd013",PhoneNumber=8596321408,Email="frank@drebin.com",Ssn=701253652,EyeColor=EyeColor.Blue,Height=75,Gender=Gender.Male},
                new Officer{OfficerID=696582,BadgeNumber=014,FirstName="Vincent",Rank=Rank.Lieutenant,LastName="Hanna",UserName="vhanna",Password="vh014",PhoneNumber=2021485068,Email="vincent@hanna.com",Ssn=708563185,EyeColor=EyeColor.Brown,Height=62,Gender=Gender.Male},
                new Officer{OfficerID=715250,BadgeNumber=015,FirstName="Clancy",Rank=Rank.Captain,LastName="Wiggum",UserName="cwiggum",Password="cw015",PhoneNumber=3658254108,Email="clancy@wiggum.com",Ssn=811829362,EyeColor=EyeColor.Brown,Height=58,Gender=Gender.Male},
