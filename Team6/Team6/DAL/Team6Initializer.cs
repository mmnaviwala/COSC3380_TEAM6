...
namespace Team6.DAL
{
    public class Team6Initializer : System.Data.Entity.DropCreateDatabaseAlways<Team6Context>
    {
        protected override void Seed(Team6Context context)
        {
            ...
            {
                new Criminal{CriminalID=123456,FirstName="John",LastName="Smith",DateOfBirth=DateTime.Parse("1971-05-20"),EyeColor=EyeColor.Brown, Weight=(155),Height=(70),Gender=Gender.Male,Ssn=(111223333),HairColor=HairColor.Brown,Race=Race.White,Address=("111 A-Street"),ZipCode=(77777),State=State.AK,PhoneNumber=(1231231231),image="~/Photos/unknown.jpg",AlternateText="unknown"},
                new Criminal{CriminalID=112233,FirstName="Carl",LastName="Johnson",DateOfBirth=DateTime.Parse("1980-11-18"),EyeColor=EyeColor.Gray,Weight=(130),Height=(55),Gender=Gender.Male,Ssn=(222334444),HairColor=HairColor.Black,Race=Race.White,Address=("222 B-Street"),ZipCode=(88888),State=State.AL,PhoneNumber=(1231231232),image="~/Photos/unknown.jpg",AlternateText="unknown"},
                new Criminal{CriminalID=223344,FirstName="Xavier",LastName="Jones",DateOfBirth=DateTime.Parse("1983-02-10"),EyeColor=EyeColor.Green,Weight=(147),Height=(80),Gender=Gender.Male,Ssn=(333445555),HairColor=HairColor.Bald,Race=Race.BlackAfricanAmerican,Address=("333 C-Street"),ZipCode=(99999),State=State.AR,PhoneNumber=(1231231233),image="~/Photos/unknown.jpg",AlternateText="unknown"},
                new Criminal{CriminalID=445566,FirstName="Adam",LastName="Rivet",DateOfBirth=DateTime.Parse("1988-04-16"),EyeColor=EyeColor.Brown,Weight=(180),Height=(68),Gender=Gender.Male,Ssn=(444556666),HairColor=HairColor.Brown,Race=Race.White,Address=("444 D-Street"),ZipCode=(11111),State=State.AZ,PhoneNumber=(1231231234),image="~/Photos/unknown.jpg",AlternateText="unknown"},
                new Criminal{CriminalID=556677,FirstName="Phil",LastName="Thomas",DateOfBirth=DateTime.Parse("2000-04-16"),EyeColor=EyeColor.Brown,Weight=(135),Height=(77),Gender=Gender.Male,Ssn=(555667777),HairColor=HairColor.Brown,Race=Race.Asian,Address=("555 E-Street"),ZipCode=(22222),State=State.CA,PhoneNumber=(1231231235),image="~/Photos/unknown.jpg",AlternateText="unknown"},
                new Criminal{CriminalID=667788,FirstName="Michael",LastName="Newman",DateOfBirth=DateTime.Parse("1992-01-30"),EyeColor=EyeColor.Brown,Weight=(110),Height=(65),Gender=Gender.Male,Ssn=(666778888),HairColor=HairColor.Brown,Race=Race.White,Address=("666 F-Street"),ZipCode=(33333),Alias=("Sean Connery"),State=State.CO,PhoneNumber=(1231231236),image="~/Photos/unknown.jpg",AlternateText="unknown"},
                new Criminal{CriminalID=778899,FirstName="Mohammad",LastName="Shirali",DateOfBirth=DateTime.Parse("1991-12-15"),EyeColor=EyeColor.Hazel,Weight=(140),Height=(70),Gender=Gender.Male,Ssn=(777889999),HairColor=HairColor.Black,Race=Race.Asian,Address=("777 G-Street"),ZipCode=(44444),Alias=("Mo Money"),State=State.CT,PhoneNumber=(1231231237),image="~/Photos/unknown.jpg",AlternateText="unknown"},
                new Criminal{CriminalID=889900,FirstName="Geordie",LastName="Daniel",DateOfBirth=DateTime.Parse("1990-6-17"),EyeColor=EyeColor.Amber,Weight=(130),Height=(68),Gender=Gender.Male,Ssn=(888990000),HairColor=HairColor.Black,Race=Race.Asian,Address=("888 H-Street"),ZipCode=(44444),Alias=("Brown Man"),State=State.DE,PhoneNumber=(1231231238),image="~/Photos/unknown.jpg",AlternateText="unknown"},
                new Criminal{CriminalID=990011,FirstName="Josh",LastName="Cooper",DateOfBirth=DateTime.Parse("1989-10-20"),EyeColor=EyeColor.Blue,Weight=(150),Height=(75),Gender=Gender.Male,Ssn=(999001111),HairColor=HairColor.Blonde,Race=Race.White,Address=("999 I-Street"),ZipCode=(55555),State=State.FL,PhoneNumber=(1231231239),image="~/Photos/unknown.jpg",AlternateText="unknown"},
                new Criminal{CriminalID=987654,FirstName="Juan",LastName="Martinez",DateOfBirth=DateTime.Parse("1990-4-05"),EyeColor=EyeColor.Blue,Weight=(200),Height=(59),Gender=Gender.Male,Ssn=(987456325),HairColor=HairColor.Black,Race=Race.Hispanic,Address=("100 J-Street"),ZipCode=(66666),Alias=("El Jefe"),State=State.GA,PhoneNumber=(1231231241),image="~/Photos/unknown.jpg",AlternateText="unknown"},
                new Criminal{CriminalID=102345,FirstName="Robert",LastName="Gonzalez",DateOfBirth=DateTime.Parse("1956-5-17"),EyeColor=EyeColor.Brown,Weight=(260),Height=(55),Gender=Gender.Male,Ssn=(899887777),HairColor=HairColor.Brown,Race=Race.Hispanic,Address=("200 K-Street"),ZipCode=(77777),Alias=("Taz"),State=State.HI,PhoneNumber=(1231231251),image="~/Photos/unknown.jpg",AlternateText="unknown"},               
                new Criminal{CriminalID=201452,FirstName="Mary",LastName="Ford",DateOfBirth=DateTime.Parse("1985-11-1"),EyeColor=EyeColor.Green,Weight=(120),Height=(72),Gender=Gender.Female,Ssn=(777722233),HairColor=HairColor.Blonde,Race=Race.White,Address=("300 L-Street"),ZipCode=(88888),Alias=("Black Widow"),State=State.IA,PhoneNumber=(1231231261),image="~/Photos/unknown.jpg",AlternateText="unknown"},
            };
