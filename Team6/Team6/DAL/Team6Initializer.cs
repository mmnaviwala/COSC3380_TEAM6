...
namespace Team6.DAL
{
    public class Team6Initializer : System.Data.Entity.DropCreateDatabaseAlways<Team6Context>
    {
        protected override void Seed(Team6Context context)
        {
            ...
            {
                new Criminal{CriminalID=123456,FirstName="John",LastName="Smith",DateOfBirth=DateTime.Parse("1971-05-20"),EyeColor=EyeColor.Brown, Weight=(155),Height=(70),Gender=Gender.Male,Ssn=(111223333),HairColor=HairColor.Brown,Race=Race.White,Address=("111 A-Street"),City=("Juneau"),ZipCode=(77777),State=State.AK,PhoneNumber=(1231231231),image="~/Photos/unknown.jpg",AlternateText="unknown"},
                new Criminal{CriminalID=112233,FirstName="Carl",LastName="Johnson",DateOfBirth=DateTime.Parse("1980-11-18"),EyeColor=EyeColor.Gray,Weight=(130),Height=(55),Gender=Gender.Male,Ssn=(222334444),HairColor=HairColor.Black,Race=Race.White,Address=("222 B-Street"),City=("Montgomery"),ZipCode=(88888),State=State.AL,PhoneNumber=(1231231232),image="~/Photos/unknown.jpg",AlternateText="unknown"},
                new Criminal{CriminalID=223344,FirstName="Xavier",LastName="Jones",DateOfBirth=DateTime.Parse("1983-02-10"),EyeColor=EyeColor.Green,Weight=(147),Height=(80),Gender=Gender.Male,Ssn=(333445555),HairColor=HairColor.Bald,Race=Race.BlackAfricanAmerican,Address=("333 C-Street"),City=("Little Rock"),ZipCode=(99999),State=State.AR,PhoneNumber=(1231231233),image="~/Photos/unknown.jpg",AlternateText="unknown"},
                new Criminal{CriminalID=445566,FirstName="Adam",LastName="Rivet",DateOfBirth=DateTime.Parse("1988-04-16"),EyeColor=EyeColor.Brown,Weight=(180),Height=(68),Gender=Gender.Male,Ssn=(444556666),HairColor=HairColor.Brown,Race=Race.White,Address=("444 D-Street"),City=("Phoenix"),ZipCode=(11111),State=State.AZ,PhoneNumber=(1231231234),image="~/Photos/unknown.jpg",AlternateText="unknown"},
                new Criminal{CriminalID=556677,FirstName="Phil",LastName="Thomas",DateOfBirth=DateTime.Parse("2000-04-16"),EyeColor=EyeColor.Brown,Weight=(135),Height=(77),Gender=Gender.Male,Ssn=(555667777),HairColor=HairColor.Brown,Race=Race.Asian,Address=("555 E-Street"),City=("Sacramento"),ZipCode=(22222),State=State.CA,PhoneNumber=(1231231235),image="~/Photos/unknown.jpg",AlternateText="unknown"},
                new Criminal{CriminalID=667788,FirstName="Michael",LastName="Newman",DateOfBirth=DateTime.Parse("1992-01-30"),EyeColor=EyeColor.Brown,Weight=(110),Height=(65),Gender=Gender.Male,Ssn=(666778888),HairColor=HairColor.Brown,Race=Race.White,Address=("666 F-Street"),City=("Denver"),ZipCode=(33333),Alias=("Sean Connery"),State=State.CO,PhoneNumber=(1231231236),image="~/Photos/unknown.jpg",AlternateText="unknown"},
                ...
                new Criminal{CriminalID=990011,FirstName="Josh",LastName="Cooper",DateOfBirth=DateTime.Parse("1989-10-20"),EyeColor=EyeColor.Blue,Weight=(150),Height=(75),Gender=Gender.Male,Ssn=(999001111),HairColor=HairColor.Blonde,Race=Race.White,Address=("999 I-Street"),City=("Miami"),ZipCode=(55555),State=State.FL,PhoneNumber=(1231231239),image="~/Photos/unknown.jpg",AlternateText="unknown"},
                ...
                new Criminal{CriminalID=102345,FirstName="Robert",LastName="Gonzalez",DateOfBirth=DateTime.Parse("1956-5-17"),EyeColor=EyeColor.Brown,Weight=(260),Height=(55),Gender=Gender.Male,Ssn=(899887777),HairColor=HairColor.Brown,Race=Race.Hispanic,Address=("200 K-Street"),City=("Dallas"),ZipCode=(77777),Alias=("Taz"),State=State.TX,PhoneNumber=(1231231251),image="~/Photos/unknown.jpg",AlternateText="unknown"},               
                new Criminal{CriminalID=201452,FirstName="Mary",LastName="Ford",DateOfBirth=DateTime.Parse("1985-11-1"),EyeColor=EyeColor.Green,Weight=(120),Height=(72),Gender=Gender.Female,Ssn=(777722233),HairColor=HairColor.Blonde,Race=Race.White,Address=("300 L-Street"),City=("Columbus"),ZipCode=(88888),Alias=("Black Widow"),State=State.OH,PhoneNumber=(1231231261),image="~/Photos/unknown.jpg",AlternateText="unknown"},
                new Criminal{CriminalID=798150,FirstName="Walter",LastName="White",DateOfBirth=DateTime.Parse("1975-11-1"),EyeColor=EyeColor.Black,Weight=(190),Height=(84),Gender=Gender.Male,Ssn=(314159265),HairColor=HairColor.Bald,Race=Race.White,Address=("300 M-Street"),City=("Albuquerque"),ZipCode=(87101),Alias=("Heisenberg"),State=State.NM,PhoneNumber=(1231231261),image="~/Photos/unknown.jpg",AlternateText="unknown"},
            };
